export enum RpcServerEvent {
    ...
    PHONE_APP_ZCHECS_GET_GAMES = 'soz-core:server:phone:app:zchecs:get-games',
    PHONE_APP_ZCHECS_GET_PROFILE = 'soz-core:server:phone:app:zchecs:get-profile',
    PHONE_APP_ZCHECS_GET_LEADERBOARD = 'soz-core:server:phone:app:zchecs:get-leaderboard',
    PHONE_APP_ZCHECS_CREATE = 'soz-core:server:phone:app:zchecs:create',
    PHONE_APP_ZCHECS_QUEUE_JOIN = 'soz-core:server:phone:app:zchecs:queue-join',
    PHONE_APP_ZCHECS_QUEUE_LEAVE = 'soz-core:server:phone:app:zchecs:queue-leave',
    PHONE_APP_ZCHECS_ACCEPT = 'soz-core:server:phone:app:zchecs:accept',
    PHONE_APP_ZCHECS_DECLINE = 'soz-core:server:phone:app:zchecs:decline',
    PHONE_APP_ZCHECS_MOVE = 'soz-core:server:phone:app:zchecs:move',
    PHONE_APP_ZCHECS_RESIGN = 'soz-core:server:phone:app:zchecs:resign',
