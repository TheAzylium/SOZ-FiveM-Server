export enum RpcServerEvent {
    ...
    PHONE_SIMCARD_GET_NAME = 'soz-core:server:phone:simcard:get-name',
    PHONE_SIMCARD_UPDATE_NAME = 'soz-core:server:phone:simcard:update-name',
    ...
    PHONE_APP_ZDROP_GET_NEARBY = 'soz-core:server:phone:app:zdrop:get-nearby',
    PHONE_APP_ZDROP_REQUEST_CONTACT = 'soz-core:server:phone:app:zdrop:request-contact',
    PHONE_APP_ZDROP_REQUEST_PHOTO = 'soz-core:server:phone:app:zdrop:request-photo',
    PHONE_APP_ZDROP_CANCEL_REQUEST = 'soz-core:server:phone:app:zdrop:cancel-request',
    PHONE_APP_ZDROP_ACCEPT_REQUEST = 'soz-core:server:phone:app:zdrop:accept-request',
    PHONE_APP_ZDROP_DECLINE_REQUEST = 'soz-core:server:phone:app:zdrop:decline-request',
