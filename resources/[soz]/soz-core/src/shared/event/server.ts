export enum ServerEvent {
    ...
    POLICE_TRAINING_ZONE_PLACE = 'soz-core:server:police:training-zone-place',
    POLICE_TRAINING_ZONE_REMOVE = 'soz-core:server:police:training-zone-remove',
    POLICE_TRAINING_ZONE_INIT = 'soz-core:server:police:training-zone-init',
