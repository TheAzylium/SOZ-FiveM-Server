export enum NuiEvent {
    ...
    PhoneAppZchecsRefresh = 'soz-core:nui:phone:app-zchecs-refresh',
    PhoneAppZchecsCreate = 'soz-core:nui:phone:app-zchecs-create',
    PhoneAppZchecsQueueJoin = 'soz-core:nui:phone:app-zchecs-queue-join',
    PhoneAppZchecsQueueLeave = 'soz-core:nui:phone:app-zchecs-queue-leave',
    PhoneAppZchecsAccept = 'soz-core:nui:phone:app-zchecs-accept',
    PhoneAppZchecsDecline = 'soz-core:nui:phone:app-zchecs-decline',
    PhoneAppZchecsMove = 'soz-core:nui:phone:app-zchecs-move',
    PhoneAppZchecsResign = 'soz-core:nui:phone:app-zchecs-resign',
    PhoneAppZchecsOfferDraw = 'soz-core:nui:phone:app-zchecs-offer-draw',
