export enum NuiEvent {
    ...
    PhoneSimCardUpdateName = 'soz-core:nui:phone:sim-card-update-name',
    ...
    PhoneAppZDropGetNearby = 'soz-core:nui:phone:app-zdrop-get-nearby',
    PhoneAppZDropRequestContact = 'soz-core:nui:phone:app-zdrop-request-contact',
    PhoneAppZDropRequestPhoto = 'soz-core:nui:phone:app-zdrop-request-photo',
    PhoneAppZDropCancelRequest = 'soz-core:nui:phone:app-zdrop-cancel-request',
    PhoneAppZDropAcceptRequest = 'soz-core:nui:phone:app-zdrop-accept-request',
    PhoneAppZDropDeclineRequest = 'soz-core:nui:phone:app-zdrop-decline-request',
    PhoneAppZDropSetDiscoverable = 'soz-core:nui:phone:app-zdrop-set-discoverable',
    PhoneAppZDropSetPlaneMode = 'soz-core:nui:phone:app-zdrop-set-plane-mode',
